...
<form class="form-login" id="frmLogin" data-toggle="validator" role="form">
	...
	<div class="login-wrap">
		...
		<div class="form-group">
			...
			<input type="password" name="txtLogPass" placeholder="Password" class="form-control" id="txtLogPass" data-error="Please enter password" pattern="(?=.*[a-zA-Z0-9]).{8,}" required>
			<span class="help-block with-errors"></span>
		</div>
		...
		<button class="btn btn-theme btn-block blue"  id="btnLoginUser" type="submit"><i class="fa fa-lock"></i> Log In</button>
		<hr>		           
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button class="btn btn-theme blue" type="submit" id="btnGetEmail">Submit</button>
					<button class="btn btn-theme blue"  type="submit" id="btnReset">Reset</button>
				</div>
			</div>
			</div>
