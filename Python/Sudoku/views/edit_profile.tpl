%rebase game_base session=session
            ...
            <div class="edit-wrap">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="txtEditName" class="form-control" id="txtEditName" data-error="Please enter a valid name" required pattern="([a-zA-Z])+" disabled="true" value="{{session['userName']}}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="txtEditZip" class="form-control" id="txtEditZip" data-error="Please enter a valid zip code" required pattern="([0-9])+" disabled="true"  value="{{session['zipCode']}}">
